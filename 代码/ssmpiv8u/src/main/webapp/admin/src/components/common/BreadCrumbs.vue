<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:40px;backgroundColor:rgba(0, 73, 142, 0.88);borderRadius:4px;padding:0px 75% 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:0;borderStyle:dotted solid double dashed;borderColor:rgba(0, 73, 142, 1);">
